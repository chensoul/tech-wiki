...
目前应用最为广泛的框架之一就是[JMH](https://openjdk.java.net/projects/code-tools/jmh/)，OpenJDK 自身也大量地使用 JMH 进行性能对比，如果你是做 Java API 级别的性能对比，JMH 往往是你的首选。
...
使用 JMH 也非常简单，你可以直接将其依赖加入 Maven 工程，如下图：![img](assets/0dd290f8842959cb02d6c3a434a58e68-20220922164631534.png)
